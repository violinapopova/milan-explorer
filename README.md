...
A **managed Expo (SDK 54)** React Native mockup of a Milan city guide — Discover feed, detail screens, five-tab navigation, mock map, and favorites persisted with AsyncStorage.
